...
const messages = {
  zh: { console: '控制台', newLog: '新建日志', overview: '概览', logs: '所有日志', myLogs: '我的日志', apiKeys: 'API 密钥', members: '成员管理', access: '权限控制', adminLogs: '日志管理', audit: '安全审计', docs: '文档', changelog: '更新日志', searchLogs: '搜索日志…', login: 'Google Workspace 登录', enterpriseTrace: '企业级智能追踪', capture: '记录工作，追踪进展。', onlyDomain: '（仅限 @example.com）', mcp: '通过 MCP 接入', api: '通过 REST API 接入', mcpDescription: '让你的 AI Agent 自动将工作成果写入 WorkTrace。', apiDescription: '用个人 API Key 将结构化工作日志直接提交到团队空间。' },
  en: { console: 'Console', newLog: 'New log', overview: 'Overview', logs: 'All logs', myLogs: 'My logs', apiKeys: 'API keys', members: 'Members', access: 'Access control', adminLogs: 'Log management', audit: 'Security audit', docs: 'Docs', changelog: 'Changelog', searchLogs: 'Search logs…', login: 'Sign in with Google Workspace', enterpriseTrace: 'Enterprise work tracing', capture: 'Capture work. Trace progress.', onlyDomain: '(@example.com only)', mcp: 'Connect via MCP', api: 'Connect via REST API', mcpDescription: 'Let your AI agent automatically write work results to WorkTrace.', apiDescription: 'Use a personal API key to submit structured work logs directly to the team.' },
} as const;
